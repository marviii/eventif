...
class SubscriptionsNewPostValid(TestCase):
    def setUp(self):
        data = dict(name='Marcos Vinicius', cpf='12345678901', email='marcos.freitas@riogrande.ifrs.edu.br', phone='53 91234-5678')
...
class TemplateRegressionTest(TestCase):
    def test_template_has_nonfield_errors(self):
        invalid_data = dict(name='Marcos Vinicius', cpf='12345678901')
